...
import br.com.rasmoo.restaurant.entity.Endereco;
import br.com.rasmoo.restaurant.vo.ClienteVO;
...
public class EnderecoDAO {
    ...
    public List<ClienteVO> consultarClientes(final String estado, final String cidade, final String rua) {
        String jpql = "SELECT new br.com.rasmoo.restaurant.vo.ClienteVO(e.cliente.clienteId.cpf,e.cliente.nome) " +
